...
<div class="container">
	<div class="row">
		<p> Здавствуйте, меня зовут Часовников Александр. Я начинающий веб-разработчик. Этот сайт создан мной в показательных и учебных целях, и не содержит уникальной информации. Вся информация взята из официальных документаций на соответствующих сайтах (<a href="">http://php.net/manual/ru/</a>, <a href="">http://htmlbook.ru</a>) и предназначена для тестирования и представления возможностей данного проета: постраничная навигация, аутентификация, администрирование (можно увидеть только через исходный код на GitHub) и многое другое. <br>Если Вам хочется со мной связаться, то отправьте мне сообщение на <strong>aleksandr.chasovnikov@gmail.com</strong> или используйте форму:
		</p>
		<br />
